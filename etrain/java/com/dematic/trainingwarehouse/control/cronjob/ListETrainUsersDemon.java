 ...
 *
 */
public class ListETrainUsersDemon extends CronjobHandler<EmptyCronjobConfiguration> {
   ...
   public List<CronjobTopic> getDefaultConfiguration() {
      ...
      defaultTopics.add(new DemonTopicBuilder(ListETrainUsersDemon.class.getSimpleName(),
               ListETrainUsersDemon.class,
               DemonTopicBuilder.INTERVAL_EVERY_HOUR).active(true).build());
